    ...
    },
    {
      ...
      items: [
        ...
        { icon: 'chatbubbles-outline', label: 'Forum', onPress: () => rootNav.navigate('Forum') },
        {
          icon: 'search-outline',
          label: 'Lost & Found',
          onPress: () => rootNav.navigate('LostFound'),
        },
      ],
    },
    {
      ...
      items: [
        {
          icon: 'scan-outline',
          label: 'Scan QR Code',
          onPress: () => rootNav.navigate('QRScanner'),
        },
        {
          icon: 'card-outline',
          label: 'Fiat On-Ramp',
          onPress: () => rootNav.navigate('FiatOnRamp'),
        },
      ],
    },
  ];
...
export default function MoreScreen() {
  return (
    <MoreStack.Navigator>
      ...
      <MoreStack.Screen name="SymptomChecker" options={{ title: 'Symptom Checker' }}>
        {() => (
          <Lazy>
